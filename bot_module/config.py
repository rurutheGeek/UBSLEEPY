...
#グローバルずかんデータ
GLOBAL_BRELOOM_DF = pd.read_csv("resource/pokedata_breloom.csv")
GLOBAL_BRELOOM_DF['ぜんこくずかんナンバー'] = GLOBAL_BRELOOM_DF['ぜんこくずかんナンバー'].apply(lambda x: str(int(x)) if x.is_integer() else str(x))